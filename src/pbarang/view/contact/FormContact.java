...
public class FormContact extends javax.swing.JFrame {
    ...
    public JTable getTabelContact() {
        return tabelContact;
    }

    public void setTabelContact(JTable tabelContact) {
        this.tabelContact = tabelContact;
    }

    public JTextField getTxtContractValue() {
        return txtContractValue;
    }

    public void setTxtContractValue(JTextField txtContractValue) {
        this.txtContractValue = txtContractValue;
    }
    ...
    public JTextArea getTxtPayment() {
        return txtPayment;
    }

    public void setTxtPayment(JTextArea txtPayment) {
    ...
    public void setTxtProjectDuration(JTextField txtProjectDuration) {
    ...
    public JTextField getTxtTglContract() {
        return txtTglContract;
    }

    public void setTxtTglContract(JTextField txtTglContract) {
        this.txtTglContract = txtTglContract;
    }
